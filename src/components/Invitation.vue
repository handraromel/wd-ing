            ...
            <div class="row justify-content-center text-center py-md-5">
              <div class="col-md-5 py-3 px-4 px-lg-5 py-md-0">
                ...
                <div class="py-4">
                  ...
                  <p>
                    ...
                    <span class="megalona fw-bold">Mr. Erfasyoni</span> <br />
              ...
              <div class="col-md-5 py-3 px-4 px-lg-5 py-md-0">
                ...
                <div class="py-4">
                  ...
                  <p>
                    First son of <br />
                    <span class="megalona fw-bold">Mr. Erwin Romel, S.E.</span>
                    <br />
                    <span class="fw-bold">&amp;</span> <br />
                    <span class="megalona fw-bold">Mrs. Nurhayati (Almh.)</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="ins-container">
            <div class="pb-5">
              ...
              <h5>
                in accordance with government regulations &amp; recommendations
              </h5>
            </div>
            <div class="row protocols">
